...
public class UsuarioHabilidadesModificaHandler implements RabbitMessageHandler {

    private final UsuarioService usuarioService;
    private final MessageToRabbit messageToRabbit;

    public UsuarioHabilidadesModificaHandler(
    ...
    public void handle(String idMensaje, String mensajeJson) throws Exception {
        try {
            ...
            messageToRabbit.processMessageMulticast(idMensaje, "usuarioHabilidadesSectorDB", retornoCambios, usuarioDatos.getIngresoDatos().getIdSector());
            messageToRabbit.processMessageMulticast(idMensaje, "usuarioHabilidadesUsuarioDB", retornoCambios, usuarioDatos.getIngresoDatos().getUsuario().getIdUsuario());
